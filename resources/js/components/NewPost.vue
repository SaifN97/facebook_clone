...
<div class="bg-white rounded shadow w-2/3 p-4">
    <div class="flex justify-between items-center">
        ...
        <div class="flex-1 mx-4">
            <input type="text" name="body" class="w-full focus:outline-none focus:shadow-outline text-sm rounded-full text-sm pl-4 h-8 bg-gray-200" placeholder="Add a post">
        </div>
        <div>
